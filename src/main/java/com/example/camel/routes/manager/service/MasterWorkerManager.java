...
public class MasterWorkerManager {
    ...
    private final AtomicBoolean initialRun = new AtomicBoolean(true);
    ...
    private void submitRecoveryTasks() {
        ...
        if (!initialRun.get()) {
            ...
            replicationCanBeStarted.set(new CountDownLatch(1));
            recoveryCompleted.set(new CountDownLatch(0));
